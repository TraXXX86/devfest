 ...
 * 
 */
public class PartnerActivity extends MGWTAbstractActivity {

	private final ClientFactory clientFactory;

	public PartnerActivity(ClientFactory clientFactory) {
	...
	public void start(AcceptsOneWidget panel,
		...
		PartnerView view = clientFactory.getPartnerView();

		// Ajout du titre principal
		view.setTitle(ConstantsUtil.MENU_PARTNERS);
