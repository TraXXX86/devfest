...
import com.gdgnantes.client.css.AppBundle;
...
public class MgwtAppEntryPoint implements EntryPoint {
	...
	private void start() {
		...
		historyHandler.register(clientFactory.getPlaceController(), clientFactory.getEventBus(), new com.gdgnantes.client.places.HomePlace());
	...
	public void onModuleLoad() {
		...
		// Window.alert("Stop onModuleLoad");
